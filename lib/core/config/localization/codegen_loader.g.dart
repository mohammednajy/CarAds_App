...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> ar = {
    ...
    "onboardingDescription1":
        "كار أدز هو وجهتك المثالية للإعلانات لمعارض السيارات ومكاتب التأجير. سواء كنت صاحب معرض أو تبحث عن استئجار سيارة، يوفر لك تطبيقنا كل ما تحتاجه!",
    "onboardingDescription2":
        "هل أنت مالك معرض سيارات أو مكتب تأجير؟ أنشئ حسابك الخاص الآن! قم بإدارة وترويج إعلاناتك بسهولة عبر خطوات بسيطة. واصل وصولك لجمهور أوسع وتلقَ استفسارات مع كار أدز.",
    "onboardingDescription3":
        "اكتشف مجموعة واسعة من إعلانات السيارات المصممة وفقاً لتفضيلاتك. تصفح مختلف طرازات السيارات، عروض التأجير، والصفقات الحصرية من المعارض المحلية مع كار أدز.",
    "next": "التالي",
    "skip": "تخطي",
